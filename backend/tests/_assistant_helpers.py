...
class FakeTools:
    ...
    async def trusted_web_search(
        ...
        # Match the production facade contract: search results are returned as
        # explicitly trusted fetched page evidence, never bare snippets.
        wrapped = [
            TrustedPageEvidence(
                result=item,
                validation_status="trusted",
            ...
            for item in (candidates or self.web_results)
        ]
        return ToolResult(ok=True, data=wrapped)
