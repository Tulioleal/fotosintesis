...
Define the shared authenticated frontend shell for private product routes, including route layout ownership, desktop and mobile navigation chrome, page canvas spacing, and footer behavior.
