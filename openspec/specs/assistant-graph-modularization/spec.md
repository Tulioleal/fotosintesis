# assistant-graph-modularization

## Purpose

Define the architectural contract for decomposing the assistant graph implementation
into a focused Python package while preserving the existing public import surface,
runtime behavior, and graph topology.
