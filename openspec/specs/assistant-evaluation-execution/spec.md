...
Define how evaluation executes and captures real assistant runs, including deterministic provider recording/replay, observed-result capture, execution-mode handling, and error classification.
