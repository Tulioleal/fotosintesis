...
required_vars="
  ...
  AUTH_LIMITER_HMAC_SECRET_KEY
  AUTH_LIMITER_ASSERTION_SECRET_KEY
  AUTH_LIMITER_ENABLED
  AUTH_LIMITER_HMAC_KEY_VERSION
  AUTH_LIMITER_MAX_RETRY_AFTER_SECONDS
  AUTH_LIMITER_RETENTION_SECONDS
  AUTH_LIMITER_CLEANUP_BATCH_SIZE
  AUTH_LIMITER_PROFILES
  ...
  GEMINI_SEARCH_MODEL
  EMBEDDING_DIMENSION
  ENRICHMENT_ACTIVITY_TERMINAL_RETENTION_HOURS
  ENRICHMENT_ACTIVITY_MAX_ITEMS
  STATIC_IP_NAME
  ...
  WORKER_CPU_LIMIT
  WORKER_MEM_LIMIT
  MIGRATION_CPU_REQUEST
  MIGRATION_MEM_REQUEST
  MIGRATION_CPU_LIMIT
  MIGRATION_MEM_LIMIT
  LIMITER_CLEANUP_CPU_REQUEST
  LIMITER_CLEANUP_MEM_REQUEST
  LIMITER_CLEANUP_CPU_LIMIT
  LIMITER_CLEANUP_MEM_LIMIT
  PROXY_CPU_REQUEST
  PROXY_MEM_REQUEST
  PROXY_CPU_LIMIT
  PROXY_MEM_LIMIT
...
for source_file in "$base_dir"/*.yaml; do
  ...
  sed \
    ...
    -e "s#__AUTH_LIMITER_HMAC_SECRET_KEY__#${AUTH_LIMITER_HMAC_SECRET_KEY}#g" \
    -e "s#__AUTH_LIMITER_ASSERTION_SECRET_KEY__#${AUTH_LIMITER_ASSERTION_SECRET_KEY}#g" \
    -e "s#__AUTH_LIMITER_ENABLED__#${AUTH_LIMITER_ENABLED}#g" \
    -e "s#__AUTH_LIMITER_HMAC_KEY_VERSION__#${AUTH_LIMITER_HMAC_KEY_VERSION}#g" \
    -e "s#__AUTH_LIMITER_MAX_RETRY_AFTER_SECONDS__#${AUTH_LIMITER_MAX_RETRY_AFTER_SECONDS}#g" \
    -e "s#__AUTH_LIMITER_RETENTION_SECONDS__#${AUTH_LIMITER_RETENTION_SECONDS}#g" \
    -e "s#__AUTH_LIMITER_CLEANUP_BATCH_SIZE__#${AUTH_LIMITER_CLEANUP_BATCH_SIZE}#g" \
    -e "s#__AUTH_LIMITER_PROFILES__#${AUTH_LIMITER_PROFILES}#g" \
    -e "s#__AUTH_LIMITER_TRUSTED_FORWARDED_HOPS__#${AUTH_LIMITER_TRUSTED_FORWARDED_HOPS}#g" \
    ...
    -e "s#__ENRICHMENT_ACTIVITY_TERMINAL_RETENTION_HOURS__#${ENRICHMENT_ACTIVITY_TERMINAL_RETENTION_HOURS}#g" \
    -e "s#__ENRICHMENT_ACTIVITY_MAX_ITEMS__#${ENRICHMENT_ACTIVITY_MAX_ITEMS}#g" \
    ...
    -e "s#__BACKEND_CPU_REQUEST__#${BACKEND_CPU_REQUEST}#g" \
    -e "s#__BACKEND_MEM_REQUEST__#${BACKEND_MEM_REQUEST}#g" \
    -e "s#__BACKEND_CPU_LIMIT__#${BACKEND_CPU_LIMIT}#g" \
    -e "s#__BACKEND_MEM_LIMIT__#${BACKEND_MEM_LIMIT}#g" \
    -e "s#__FRONTEND_CPU_REQUEST__#${FRONTEND_CPU_REQUEST}#g" \
    -e "s#__FRONTEND_MEM_REQUEST__#${FRONTEND_MEM_REQUEST}#g" \
    -e "s#__FRONTEND_CPU_LIMIT__#${FRONTEND_CPU_LIMIT}#g" \
    -e "s#__FRONTEND_MEM_LIMIT__#${FRONTEND_MEM_LIMIT}#g" \
    ...
    -e "s#__MIGRATION_CPU_REQUEST__#${MIGRATION_CPU_REQUEST}#g" \
    -e "s#__MIGRATION_MEM_REQUEST__#${MIGRATION_MEM_REQUEST}#g" \
    -e "s#__MIGRATION_CPU_LIMIT__#${MIGRATION_CPU_LIMIT}#g" \
    -e "s#__MIGRATION_MEM_LIMIT__#${MIGRATION_MEM_LIMIT}#g" \
    -e "s#__LIMITER_CLEANUP_CPU_REQUEST__#${LIMITER_CLEANUP_CPU_REQUEST}#g" \
    -e "s#__LIMITER_CLEANUP_MEM_REQUEST__#${LIMITER_CLEANUP_MEM_REQUEST}#g" \
    -e "s#__LIMITER_CLEANUP_CPU_LIMIT__#${LIMITER_CLEANUP_CPU_LIMIT}#g" \
    -e "s#__LIMITER_CLEANUP_MEM_LIMIT__#${LIMITER_CLEANUP_MEM_LIMIT}#g" \
    -e "s#__PROXY_CPU_REQUEST__#${PROXY_CPU_REQUEST}#g" \
    -e "s#__PROXY_MEM_REQUEST__#${PROXY_MEM_REQUEST}#g" \
    -e "s#__PROXY_CPU_LIMIT__#${PROXY_CPU_LIMIT}#g" \
    -e "s#__PROXY_MEM_LIMIT__#${PROXY_MEM_LIMIT}#g" \
